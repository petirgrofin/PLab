...
const DropdownExplanation = ({ explanation, id, src }) => {
  ...
  return (
    <div className={`mt-4 ${isExerciseCompleted ? 'opacity-100' : 'opacity-0'} ${isOpen && showExplanation && id == exerciseId ? 'mb-32' : 'mb-0'}`} ref={explanationRef}>
      <button
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          {src !== undefined ? <img src={src} className="object-scale-down h-[300px]" alt="" /> : <></>}
